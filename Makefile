...
test-fixtures:
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-01.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-02.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-03.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-04.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-05.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-06.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-07.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-08.xml \
		"$(URL_UNSUMMARIZED)?listZipCodeList=20910+25414"

	# Unsummarized Data for a List of Cities
	curl --output ndfd/src/test/fixtures/response-unsummarized-09.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-10.xml \
		"$(URL_UNSUMMARIZED)?listCitiesLevel=12"

	# Unsummarized Data for a Subgrid Defined by a Center Point
	curl --output ndfd/src/test/fixtures/response-unsummarized-11.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-12.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-13.xml \
		"$(URL_UNSUMMARIZED)?sector=conus"

	# Unsummarized Data for a Single Time Encoded in dwGML
	curl --output ndfd/src/test/fixtures/response-unsummarized-14.xml \
	...
	curl --output ndfd/src/test/fixtures/response-unsummarized-15.xml \
	...
	curl --output ndfd/src/test/fixtures/response-summarized-04.xml \
	...
	curl --output ndfd/src/test/fixtures/response-summarized-05.xml \
		"$(URL_SUMMARIZED)?zipCodeList=20910+25414&format=24+hourly&numDays=7"

	# Summarized Data for a List of Cities
	curl --output ndfd/src/test/fixtures/response-summarized-06.xml \
